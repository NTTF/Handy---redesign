...
const AccessibilityPermissions: React.FC = () => {
  ...
  const buttonConfig: Record<PermissionState, ButtonConfig | null> = {
    request: {
      ...
      className:
        "px-2 py-1 text-sm font-medium bg-mid-gray/10 border  border-mid-gray/80 hover:bg-logo-primary/10 rounded cursor-pointer hover:border-logo-primary",
    },
    verify: {
      text: t("accessibility.openSettings"),
      className:
  ...
  return (
    <div className="p-4 w-full rounded border border-mid-gray">
